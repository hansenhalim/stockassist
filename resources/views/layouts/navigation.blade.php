        ...
        @if (request()->routeIs('home'))
            <div class="text-center py-3">
                <div style="background-color: var(--md-sys-color-secondary-container);"
                    ...
                    <svg fill="#0b1f15" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960"
                        width="24px">
                        <path d="M160-120v-480l320-240 320 240v480H560v-280H400v280H160Z" />
                    </svg>
                </div>
                <div class="md-typescale-label-medium mt-1" style="color: var(--md-sys-color-on-secondary-container);">
                    Home
                </div>
            </div>
        @else
            <a href="{{ route('home') }}">
                <div class="text-center py-3">
                    <div class="w-16 flex justify-center py-1">
                        <svg fill="#404943" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960"
                            width="24px">
                            <path
                                d="M240-200h120v-240h240v240h120v-360L480-740 240-560v360Zm-80 80v-480l320-240 320 240v480H520v-240h-80v240H160Zm320-350Z" />
                        </svg>
                    </div>
                    <div class="md-typescale-label-medium mt-1" style="color: var(--md-sys-color-on-surface-variant);">
                        Home
                    </div>
                </div>
            </a>
