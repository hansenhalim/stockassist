<x-app-layout>
    ...
    <div class="mx-auto px-4">
        <div class="rounded-3xl shadow-md overflow-hidden">
            @if ($recipe->photo)
                <div class="h-56 bg-center" style="background-image: url('{{ url('storage/' . $recipe->photo) }}');">
                </div>
            @else
        ...
        <div class="flex justify-between items-center mt-4">
            <div class="md-typescale-headline-medium">{{ $recipe->name }}</div>
        ...
        <div class="flex justify-between mt-4">
            <md-outlined-button href="{{ route('recipes.edit', $recipe) }}">Back</md-outlined-button>
            <div class="flex">
